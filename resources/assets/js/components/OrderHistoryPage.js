              ...
              <Paper className="col s12" zDepth={1} style={{ padding: 10, marginTop: 10 }}>
                <Card expanded={this.state.expanded} onExpandChange={this.handleExpandChange} className="col s12" zDepth={0} >
                  ...
                  <CardText>
                    <small style={{ fontSize: 12 }}>
                      <i>
                      {
                        this.props.ordersHistory.total ?
                          <span>
                            Menampilkan <b>{ this.props.ordersHistory.from }</b> - <b>{ this.props.ordersHistory.to }</b> dari total <b>{ this.props.ordersHistory.total }</b> Pemesanan Saya
                            {
                    ...
                    <OrderContainer orders={this.props.ordersHistory.data || [] } />
                    <Pager
