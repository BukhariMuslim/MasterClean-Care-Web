    ...
    return (
      <div>
        ...
        >
          {
            isLoggedIn ?
              <Header username={this.props.user.name} role={this.props.user.role} wallet={this.props.user.user_wallet} avatarImg={(this.props.user.avatar ? '/image/small/' + this.props.user.avatar : '') || LockImg} bgImg={BgImg} />
              :
