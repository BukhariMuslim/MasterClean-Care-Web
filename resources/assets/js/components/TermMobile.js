    ...
    return (
      <Paper className="col s12" zDepth={1} style={{ padding: '10px', marginTop: '10px' }}>
        ...
        <ul className="collection with-header">
          ...
          <li className="collection-item">Anda wajib memberikan informasi yang diminta dengan lengkap, faktual dan benar. Kerugian karena Anda yang memberikan informasi kurang lengkap bukanlah bagian dari tanggung jawab pihak Master Clean &amp; Care.</li>
